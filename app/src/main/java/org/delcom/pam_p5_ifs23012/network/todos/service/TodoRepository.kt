package org.delcom.pam_p5_ifs23012.network.todos.service

import okhttp3.MultipartBody
import org.delcom.pam_p5_ifs23012.helper.SuspendHelper
import org.delcom.pam_p5_ifs23012.network.data.ResponseMessage
import org.delcom.pam_p5_ifs23012.network.todos.data.RequestAuthLogin
import org.delcom.pam_p5_ifs23012.network.todos.data.RequestAuthLogout
import org.delcom.pam_p5_ifs23012.network.todos.data.RequestAuthRefreshToken
import org.delcom.pam_p5_ifs23012.network.todos.data.RequestAuthRegister
...
import org.delcom.pam_p5_ifs23012.network.todos.data.ResponseAuthLogin
import org.delcom.pam_p5_ifs23012.network.todos.data.ResponseAuthRegister
import org.delcom.pam_p5_ifs23012.network.todos.data.ResponseTodo
import org.delcom.pam_p5_ifs23012.network.todos.data.ResponseTodoAdd
import org.delcom.pam_p5_ifs23012.network.todos.data.ResponseTodos
import org.delcom.pam_p5_ifs23012.network.todos.data.ResponseUser
...
class TodoRepository(
    ...
    override suspend fun putUserMePassword(
        authToken: String,
        request: org.delcom.pam_p5_ifs23012.network.todos.data.RequestUserChangePassword
    ): org.delcom.pam_p5_ifs23012.network.data.ResponseMessage<String?> {
        return org.delcom.pam_p5_ifs23012.helper.SuspendHelper.safeApiCall {
            apiService.putUserMePassword("Bearer $authToken", request)
        }
    }

    override suspend fun putUserMePhoto(authToken: String, file: okhttp3.MultipartBody.Part): ResponseMessage<String?> {
        return SuspendHelper.safeApiCall {
    ...
    override suspend fun getTodos(authToken: String, search: String?, isDone: Boolean?, urgency: String?, page: Long, perPage: Int): ResponseMessage<ResponseTodos?> {
        return SuspendHelper.safeApiCall {
    ...
    override suspend fun putTodo(
        ...
        return SuspendHelper.safeApiCall {
            // Pemanggilan @Path di apiService memakai id, jadi kita kirimkan todoId
