...
fun TodosEditScreen(
        ...
        when (val state = uiStateTodo.todoChange) {
            is TodoActionUIState.Success -> {
                SuspendHelper.showSnackBar(
                    ...
                    message = "Perabotan berhasil diperbarui" // Pesan notifikasi disesuaikan
                )
                RouteHelper.to(
    ...
    Column(
        ...
        TopAppBarComponent(
            navController = navController,
            title = "Ubah Data Perabotan", // Judul AppBar disesuaikan
            showBackButton = true,
        )
...
fun TodosEditUI(
    ...
    var dataUrgency by remember { mutableStateOf(todo.urgency ?: "Mulus") } // Default value disesuaikan

    // Mengubah daftar urgensi menjadi pilihan kondisi barang
    ...
    Column(
        ...
        // Form Status Penjualan (Memanfaatkan field Is Done)
        Column(
            modifier = Modifier.fillMaxWidth()
        ) {
            Text(
            ...
            Row(
                ...
                Text("Terjual", style = MaterialTheme.typography.bodyMedium)
        ...
        // Form Kondisi Barang (Memanfaatkan Urgency Radio Buttons)
        Text(
            text = "Kondisi Barang:",
            style = MaterialTheme.typography.labelLarge,
            color = MaterialTheme.colorScheme.onPrimaryContainer
    ...
    Box(
        ...
        FloatingActionButton(
            ...
            Icon(
                ...
                contentDescription = "Simpan Perubahan Data"
            )
        }
    }
