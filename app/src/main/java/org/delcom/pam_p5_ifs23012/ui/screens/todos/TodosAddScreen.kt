...
import org.delcom.pam_p5_ifs23012.helper.AlertHelper
import org.delcom.pam_p5_ifs23012.helper.AlertState
import org.delcom.pam_p5_ifs23012.helper.AlertType
...
fun TodosAddScreen(
    ...
    fun onSave(
        ...
        tmpTodo = ResponseTodoData(
            ...
            urgency = urgency,
            isDone = false // Barang baru ditambahkan, otomatis dianggap masih "Tersedia" (false)
        )
        ...
        when (val state = uiStateTodo.todoAdd) {
            is TodoActionUIState.Success -> {
                SuspendHelper.showSnackBar(
                    ...
                    message = "Perabotan berhasil ditambahkan" // Penyesuaian pesan sukses
                )
                RouteHelper.to(
                    navController,
    ...
    Column(
        ...
        TopAppBarComponent(
            ...
            title = "Tambah Perabotan", // Disesuaikan dengan konteks toko
            showBackButton = true,
        )
        Box(
            modifier = Modifier
...
fun TodosAddUI(
    ...
    var dataUrgency by remember { mutableStateOf(tmpTodo?.urgency ?: "Mulus") }

    // PENJELASAN: Memetakan tingkat urgensi Todo menjadi tingkat kondisi barang Perabotan
    val urgencyOptions = listOf("Mulus", "Normal", "Minus")
    ...
    Column(
        ...
        // Input Nama Perabotan (Memanfaatkan field title)
        OutlinedTextField(
            value = dataTitle,
            ...
            label = {
                Text(
                    text = "Nama Perabotan (mis. Meja Belajar Jati)",
        ...
        // Input Deskripsi & Harga (Memanfaatkan field description)
        OutlinedTextField(
        ...
        // Pilihan Kondisi Barang (Memanfaatkan field urgency)
        Text(
            text = "Kondisi Barang:",
        ...
        Row(
            ...
            urgencyOptions.forEach { option ->
                Row(
                    ...
                    RadioButton(
                        selected = (dataUrgency == option),
                        onClick = { dataUrgency = option }
                    )
                    Text(
                        text = option,
    ...
    Box(
        ...
        FloatingActionButton(
            onClick = {
                if(dataTitle.isEmpty()) {
                    AlertHelper.show(
                        alertState,
                        AlertType.ERROR,
                        "Nama perabotan tidak boleh kosong!"
                    )
            ...
            Icon(
                ...
                contentDescription = "Simpan Perabotan"
            )
        }
    }
